...
for (var i_1 = 1; i_1 <= 10; i_1++) {
    var Lesson = { name: "Lesson ".concat(i_1),
        lessonType: i_1 % 2 === 0 ? 'even' : 'odd',
        includesThisYear: i_1 % 2 != 0 ? true : false }; //assume only odd lesson are included
    myWork.push(Lesson);
}
;
for (var _i = 0, myWork_1 = myWork; _i < myWork_1.length; _i++) {
    var x_1 = myWork_1[_i];
    console.log(x_1);
}
;
...
var userGuess = [1, 2, 3, 4, 4, 5, 6, 7, 8, 9, 10];
var i = 0;
console.log("\n\n \t Question Number 2 \n\n");
...
;
console.log(" you guessed the number in ".concat(i, " attempts"));
...
for (var x_2 in Objects) {
    console.table(x_2 && Objects[x_2]);
}
...
for (var i_2 = 1; i_2 <= 600; i_2 = i_2 * 2) {
    myArray.push(i_2);
}
;
console.table(myArray); // log array into console
for (var i_3 = 0; i_3 < myArray.length; i_3++) // for loop to iterate through array
 {
    console.log("index no. ", i_3, " :", " value is ", myArray[i_3]);
}
;
for (var _a = 0, myArray_1 = myArray; _a < myArray_1.length; _a++) {
    var x_3 = myArray_1[_a];
    console.log(x_3);
}
